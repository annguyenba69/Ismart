            ...
            <form action="{{url('admin/product/store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea name="detail" class="form-control" id="detail" cols="30" rows="5"
                        style="height: 600px">{!!old('detail')!!}</textarea>
                    @error('detail')
                    <small class="text-danger">{{$message}}</small>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control" id="" name="product_cat_id">
                        ...
                        <option {{old('product_cat_id') == $product_cat->id?'selected':''}} value="{{$product_cat->id}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status_warehouse"
                                    id="status_warehouse_0" value="0" checked>
    ...
    $(document).ready(function() {
            ...
            $("#filename").change(function(){
                ...
                success: function(data){
                    if(data.status == "1"){
                        console.log(data.thumbnails_html);
